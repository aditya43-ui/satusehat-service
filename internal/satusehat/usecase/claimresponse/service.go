...
type Service interface {
	Create(ctx context.Context, req ClaimResponseRequest) (*satusehat.FHIRResponse, error)
	Update(ctx context.Context, id string, req ClaimResponseRequest) (*satusehat.FHIRResponse, error)
...
func (s *service) Create(ctx context.Context, req ClaimResponseRequest) (*satusehat.FHIRResponse, error) {
...
func (s *service) Update(ctx context.Context, id string, req ClaimResponseRequest) (*satusehat.FHIRResponse, error) {
	if id == "" {
		return nil, errors.NewValidationError().Message("ClaimResponse ID is required").Build()
	}
	if req.OrganizationID == "" {
		req.OrganizationID = s.orgID
	}
